...
describe("generateContestantRoundScores", () => {
  it("Should work with simple defaults", () => {
    ...
    // Act
    const result = LeagueStanding.generateContestantRoundScores(
      teamList,
      rounds,
      "",
    );
  ...
  it("Should output some score when there is one", () => {
    // Arrange
    let exampleTeam = new Team({
      teamName: "name1_1 & name1_2",
      isParticipating: true,
      eliminationOrder: 0,
    });
    let exampleTeam2 = new Team({
      teamName: "name2_1 & name2_2",
      isParticipating: true,
      eliminationOrder: 0,
    });
...
describe("addContestantRoundScores", () => {
  ...
  it("Should modify totalScore if handicap is not passed", () => {
    ...
    // Act
    sut.addContestantRoundScores(
      teamList,
      rounds,
      expectedContestantName1,
      expectedHandicap,
    );
