...
describe("Regression Tests Checking Scoring of Archived Leagues", () => {
    ...
    it("Should Score Sean correctly for Big Brother 27", () => {
        ...
        // Arrange
        const seansRawTeamList = [ { teamName: "Isaiah \"Zae\" Frederich", relationship: "Salesperson", isParticipating: false, eliminationOrder: 1 }, { teamName: "Amy Bingham", relationship: "Insurance agent", isParticipating: false, eliminationOrder: 2 }, { teamName: "Adrian Rocha", relationship: "Carpenter", isParticipating: false, eliminationOrder: 3 }, { teamName: "Jimmy Heagerty", relationship: "Strategy consultant", isParticipating: false, eliminationOrder: 4 }, { teamName: "Zach Cornell", relationship: "Marketing manager", isParticipating: false, eliminationOrder: 5 }, { teamName: "Rylie Jeffries", relationship: "Professional bull rider", isParticipating: false, eliminationOrder: 6 }, { teamName: "Katherine Woodman", relationship: "Fine dining server", isParticipating: false, eliminationOrder: 7 }, { teamName: "Mickey Lee", relationship: "Event curator", isParticipating: false, eliminationOrder: 8 }, { teamName: "Rachel Reilly", relationship: "TV personality", isParticipating: false, eliminationOrder: 9 }, { teamName: "Cliffton \"Will\" Williams", relationship: "College sports podcaster", isParticipating: false, eliminationOrder: 10 }, { teamName: "Kelley Jorgensen", relationship: "Web designer", isParticipating: false, eliminationOrder: 11 }, { teamName: "Lauren Domingue", relationship: "Bridal stylist", isParticipating: false, eliminationOrder: 12 }, { teamName: "Keanu Soto", relationship: "Dungeon master", isParticipating: false, eliminationOrder: 13 }, { teamName: "Ava Pearl", relationship: "Aura painter", isParticipating: false, eliminationOrder: 14 }, { teamName: "Morgan Pope", relationship: "Gamer", isParticipating: false, eliminationOrder: 15 }, { teamName: "Vince Panaro", relationship: "Unemployed", isParticipating: false, eliminationOrder: 16 }, { teamName: "Ashley Hollis", relationship: "Attorney", isParticipating: true, eliminationOrder: 1.7976931348623157e+308 } ]
