import {
  WIKI_API_URL,
  GOOGLE_SHEET_URL,
} from "../../../leagueConfiguration/AmazingRace_35";
...
export default async function Scoring() {
  ...
  return (
    <div>
      ...
      />
      <p>
        This season was largely managed by Andrew Jaicks using{" "}
        <a className="standard-link" href={GOOGLE_SHEET_URL}>
          this google sheet
        </a>{" "}
        which was populated by him based on SMSs sent by the league contestants.
      </p>
      <br />
    </div>
  );
