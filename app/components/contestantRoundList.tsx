    ...
    <>
      <div className="text-center">
        {perfectRoundScores.map((round: IRound, roundNumber: number) => {
          ...
          const perfectRound = round.contestantRoundData.filter(
            (x: IContestantRoundData) => x.name === "*perfect*",
          )[0];
          ...
          const filteredContestantRound =
            contestantRound.contestantRoundData.filter(
              (x: IContestantRoundData) => x.name === contestantName,
            )[0];
