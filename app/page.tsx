    ...
    return (
        <>
            <div className="site-notice">
                <p>
                    If you would like to participate, email <Link className="standard-link" href="mailto:xfactorleaguesite@gmail.com">xfactorleaguesite@gmail.com</Link> and we will see what we can do.
                </p>
            </div>
            {pages.map((p: IPage) => { 
