    ...
    return (
        <>
            <p className="site-notice">
                A new league for Amazing Race 37 is about to start up. Emails to submit your ranking have gone out. If you are interested and did not get an email, please email <Link className="standard-link" href="mailto:xfactorleaguesite@gmail.com">xfactorleaguesite@gmail.com</Link>.
            </p>
            {pages.map((p: IPage) => { 
