        ...
        <div>
            ...
            <div className="text-center">
                {roundScores.map((score, roundNumber) => {
                    ...
                    return <Round roundNumber={roundNumber} perfectTeamList={reverseTeamsList} contestantTeamList={currentSelectedContestantTeamsList} perfectWeekScore={score} contestantWeekScore={contestantRoundScore} perfectGrandTotal={grandTotal} contestantGrandTotal={contestantGrandTotal} />
                })}
            </div>
        </div>
    )
